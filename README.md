...
| [Анализ поведения пользователей мобильного приложения](https://github.com/whosdatt/Portfolio/tree/main/Mobile%20app)      | Анализировала поведения пользователей, выявила наиболее популярные сценарии. Проверила две гипотезы о равенстве конверсий      | Python, Pandas, Matplotlib, Plotly, SciPy, NumPy, A/B-тестирование, событийная аналитика, продуктовая метрика       |
